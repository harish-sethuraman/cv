...
<div className="flex w-full sm:justify-center mt-2 gap-2">
  ...
  <Socials type="web" href="https://github.com/harish-sethuraman">
    strek.in
  </Socials>
  <Socials type="linkedin" href="https://github.com/harish-sethuraman">
    harish-sethuraman
  </Socials>
</div>
...
- **Built Design System** that powers 5+ internal tools
  ...
  - Started the entire design system with tailwind plugin, UI library, fonts library
...
- Built a in-house **Drag and Drop** Form builder
  - Built a **server driven** form builder for internal portals
  - Allowed **importing existing** server driven forms and form templates
  - Drag and Drop to build new and edit forms for internal portals to create server driven UI
  - **import and export** form schemas to enable creation of frontend forms as well
